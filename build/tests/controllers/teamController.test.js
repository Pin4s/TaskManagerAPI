  ...
  "node_modules/superagent/lib/utils.js"(exports2) {
    ...
    exports2.params = (value) => {
      ...
      for (const string_ of value.split(/ *; */)) {
        ...
        if (key && value2) object2[key] = value2;
      }
      return object2;
    };
    ...
    exports2.isObject = (object2) => {
      return object2 !== null && typeof object2 === "object";
    };
    exports2.hasOwn = Object.hasOwn || function(object2, property) {
      if (object2 == null) {
...
var require_node2 = __commonJS({
  "node_modules/superagent/lib/node/index.js"(exports2, module2) {
    ...
    Request.prototype.auth = function(user, pass, options) {
      ...
      const encoder = (string2) => Buffer.from(string2).toString("base64");
    ...
    module2.exports = function(app2, options = {}) {
      ...
      methods.forEach(function(method) {
        obj[method] = function(url) {
          var test2 = new Test(app2, method, url, options.http2);
          if (options.http2) {
            test2.http2();
          }
          return test2;
...
// src/tests/controllers/teamController.test.ts
...
describe("taskController", () => {
  ...
  let token;
  beforeAll(async () => {
    const resRegister = await (0, import_supertest.default)(app).post("/register").send({
      name: "Test User",
      email: `testuser${Date.now()}@example.com`,
      password: "password123"
    });
    user_id = resRegister.body.userWithoutPassword.id;
    const resLogin = await (0, import_supertest.default)(app).post("/sessions").send({
  ...
  test("Should NOT list teams without auth", async () => {
    const response = await (0, import_supertest.default)(app).get("/teams");
